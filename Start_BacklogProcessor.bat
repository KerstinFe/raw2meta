...
title Raw2Meta Backlog Processor
echo Starting Raw2Meta File Backlog Processor...
...
echo Running Backlog Processor...
REM Run the script using the virtual environment's Python
"%PROJECT_DIR%\.venv\Scripts\python.exe" "%PROJECT_DIR%\src\raw2meta\pipeline\pipeline_BacklogProcessor.py"
