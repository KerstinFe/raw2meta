...
title Raw2Meta Insert Corrupt Files
echo Starting Raw2Meta Insert Corrupt Files...
...
echo Running Insert Corrupt Files...
REM Run the script using the virtual environment's Python
"%PROJECT_DIR%\.venv\Scripts\python.exe" "%PROJECT_DIR%\src\raw2meta\pipeline\pipeline_InsertCorruptFiles.py"

echo Raw2Meta Insert Corrupt Files stopped.
pause