...
title "Raw2Meta Replace Files"
echo Starting Raw2Meta Replace Files...
...
echo Running Replace Files...
REM Run the script using the virtual environment's Python
"%PROJECT_DIR%\.venv\Scripts\python.exe" "%PROJECT_DIR%\src\raw2meta\pipeline\pipeline_ReplaceFiles.py"

echo Raw2Meta Replace Files stopped.
pause